...
--
-- Host: 141.64.22.18
-- Erstellungszeit: 25. Jun 2014 um 14:44
...
CREATE TABLE IF NOT EXISTS `artikel` (
  `artikelnummer` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `bezeichnung` varchar(255) NOT NULL,
  `preis` decimal(6,2) NOT NULL,
  `artikelgruppe` int(11) unsigned NOT NULL,
  `hersteller` int(11) unsigned NOT NULL,
  PRIMARY KEY (`artikelnummer`),
  KEY `artikelgruppe` (`artikelgruppe`),
...
CREATE TABLE IF NOT EXISTS `bestellung` (
  ...
  `kunde` int(11) unsigned DEFAULT NULL,
...
(1, 1, 2, '2013-01-01 07:23:11', '2013-01-03 00:11:35', '2013-01-25 00:11:35', '0000-00-00 00:00:00', 1),
(2, 1, 2, '2013-09-23 11:12:13', '0000-00-00 00:00:00', '2013-10-10 00:11:57', '0000-00-00 00:00:00', 3),
...
(5, 12, 3, '2013-05-01 13:11:19', '2013-05-05 16:45:52', '2013-07-21 16:45:52', '2013-06-11 16:45:52', 1),
(6, 1, 8, '2013-10-10 19:19:19', '0000-00-00 00:00:00', '2013-10-11 16:44:03', '0000-00-00 00:00:00', 6),
(7, 13, 6, '2013-09-09 07:12:49', '2013-08-09 16:47:50', '2013-10-11 16:47:50', '2013-09-11 16:47:50', 9),
(8, 100, 5, '2013-07-07 16:52:39', '2013-08-11 16:47:50', '0000-00-00 00:00:00', '2013-10-11 16:47:50', 4),
...
(11, 1, 2, '2013-11-15 16:59:03', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 4);
...
(8, 'Karl', 'Schmitt', 48, 'Hauptstraße 99', 60666, 'Frankfurt', 'Deutschland', '2013-10-01 13:12:29'),
...
--
ALTER TABLE `artikel`
  ADD CONSTRAINT `artikel_ibfk_1` FOREIGN KEY (`artikelgruppe`) REFERENCES `artikelgruppe` (`id`),
  ADD CONSTRAINT `artikel_ibfk_2` FOREIGN KEY (`hersteller`) REFERENCES `hersteller` (`id`);

--
-- Constraints der Tabelle `bestellung`
--
ALTER TABLE `bestellung`
  ADD CONSTRAINT `bestellung_ibfk_1` FOREIGN KEY (`artikel`) REFERENCES `artikel` (`artikelnummer`),
  ADD CONSTRAINT `bestellung_ibfk_3` FOREIGN KEY (`kunde`) REFERENCES `person` (`id`) ON UPDATE CASCADE;
